...
go("effort=low, temp 0 (baseline)",        {})
go("effort=low + repetition_penalty 1.05", {"repetition_penalty":1.05})
go("effort=low + temp 0.7 top_p 0.95",     {"temperature":0.7,"top_p":0.95})
