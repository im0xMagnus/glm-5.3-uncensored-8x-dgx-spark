...
gpu_clock() {
  ...
  ssh -o BatchMode=yes -o ConnectTimeout=15 "$USER@<NODE_PREFIX>.$1" "sudo -n $c 2>&1 | tail -1; nvidia-smi --query-gpu=clocks.gr --format=csv,noheader"
}
